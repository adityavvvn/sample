...
const Home = () => (
  <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-900 via-blue-950 to-purple-900 overflow-x-hidden">
    {/* Hero Section */}
    <section className="flex-1 flex flex-col justify-center items-center text-center px-4 pt-24 pb-12 relative w-full">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[90vw] h-[90vw] max-w-[600px] max-h-[600px] bg-gradient-to-br from-blue-600/30 via-purple-500/20 to-transparent rounded-full blur-3xl opacity-60 animate-pulse"></div>
      </div>
      <div className="relative z-10">
        ...
        <p className="text-base sm:text-xl md:text-2xl text-blue-100 mb-8 animate-pulse-slow">
          Build your portfolio, match with jobs, and grow your career—all in one place.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10 w-full max-w-sm sm:max-w-none">
          <Link to="/login" className="px-8 py-3 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-lg shadow-lg transition-all duration-200 transform hover:scale-105 w-full sm:w-auto text-center">
            Login
          </Link>
          <Link to="/register" className="px-8 py-3 rounded-xl bg-gradient-to-r from-purple-600 to-blue-500 hover:from-purple-700 hover:to-blue-600 text-white font-bold text-lg shadow-lg transition-all duration-200 transform hover:scale-105 w-full sm:w-auto text-center">
            Register
          </Link>
        </div>
    ...
    {/* Features Section */}
    <section className="relative z-10 max-w-5xl mx-auto px-4 py-12 w-full">
